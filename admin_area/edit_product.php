...
if(!isset($_SESSION['admin_email'])){
	...
	if(isset($_GET['edit_product'])){
		...
		$p_keywords = $row_edit['products_keywords'];
	}
	...
	if(isset($_POST['update'])){
		...
		$update_product = "update products set p_cat_id='$product_cat',cat_id='$cat',date=NOW(),product_title='$product_title',product_img1='$product_img1',product_price='$product_price',product_desc='$product_desc',products_keywords='$product_keywords' where product_id='$p_id'";
