<div class="panel panel-default sidebar-menu">
	<div class="panel-heading">
		<center>
			<img src="customer_images/katti.jpg" alt="" style="width: 100%;">
		</center>
		<br>
		<h3 align="center" class="panel-title">Name:Anirudh Katti</h3>
	</div>
	<div class="panel-body">
		<ul class="nav nav-pills nav-stacked">
			...
			<li class="<?php if(isset($_GET['edit_account'])){echo "active";}?>">
				<a href="my_account.php?edit_account"><i class="fa fa-pencil"></i>  Edit</a>
			</li>
			...
			<li>
				<a href="logout.php"><i class="fa fa-sign-out"></i>  Delete Account</a>
			</li>
		</ul>
	</div>
</div>