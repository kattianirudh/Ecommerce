...
<form action="" method="post" style="margin-bottom: 10%;">
	...
	<div class="form-group">
		...
		<img src="customer_images/<?php echo $customer_image; ?>" alt="Not avaiable" class="image-responsive" style="width: 100px;height: 100px;">
	</div>
...
<?php
	if(isset($_POST['update'])){
		...
		$cc_image = $_POST['c_image'];
		$update_customer = "update customers set customer_name='$c_name',customer_email='$c_email',customer_country='$c_country',customer_city='$c_city',customer_contact='$c_contact',customer_address='$c_address',customer_image='$cc_image' where customer_id='$update_id'";
